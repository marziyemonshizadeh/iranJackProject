  ...
  return (
    ...
    <nav className="flex w-full overflow-hidden lg:justify-end md:justify-between justify-center items-center lg:gap-[121px] md:gap-2 gap-1 p-3 bg-[#FEFEFE] rounded-bl-3xl shadow-sm h-[64px]">
      ...
      <div className="flex items-center justify-center md:gap-4 sm:gap-3 pe-5">
        <div className="flex items-center gap-2 w-[146px] h-[28px] text-xs font-normal rounded-full shadow-slate-100 bg-[#F5F5F5] text-[#444444] border border-[#EAEAEA]  shadow-inner px-3 py-2">
          <span>8:54:12</span>
